  ...
  return (
    <section className="flex gap-5 mb-10 p-8 bg-lime-50 rounded-xl w-[1236px] max-md:flex-wrap max-md:pr-5">
      ...
      <nav className="flex flex-col my-auto text-base font-black whitespace-nowrap text-stone-400">
        <button onClick={handleView} className="justify-center px-14 py-5 mb-6 rounded-xl bg-stone-500 text-white max-md:px-5" tabIndex="0">View</button>
        <button onClick={handleUpdate} className="justify-center px-16 py-5 rounded-xl bg-stone-500 text-white max-md:pr-6 max-md:pl-5" tabIndex="0">Edit</button>
      </nav>
    </section>
  );
}
      ...
      <div className="justify-center items-center flex overflow-x-hidden overflow-y-auto fixed inset-0 z-50 outline-none focus:outline-none">
        <div className="relative w-auto my-6 mx-auto max-w-3xl">
          ...
          <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
            ...
            {/*body*/}
            <div className="flex flex-col justify-items-center mt-3 space-y-2">
    ...
    <div className="flex flex-col items-center pt-12 bg-white">
      ...
      <footer className="flex gap-5 items-start self-stretch px-3 pt-7 pb-3.5 mt-12 w-full font-black bg-stone-400 text-stone-500 max-md:flex-wrap max-md:mt-10 max-md:max-w-full">
        <div className="flex gap-0 self-start text-xs">
          <img src='https://cdn.builder.io/api/v1/image/assets/TEMP/9b300a7b5ec1ca9295e757297eb45d2927ba83a01c43b4d387002a419f0886e8?apiKey=6aa320d50fc04f13ae8b58abb91612c7&'className="shrink-0 aspect-[0.93] w-[39px]" alt="KopiIn logo" />
